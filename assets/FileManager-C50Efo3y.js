...
`,[S("absolute",`
 ...
 padding-bottom ${o} ${q}
 ${n?`,${n}`:""}
 `)]}const Dt={paddingSmall:"12px 16px 12px",paddingMedium:"19px 24px 20px",paddingLarge:"23px 32px 24px",paddingHuge:"27px 40px 28px",titleFontSizeSmall:"16px",titleFontSizeMedium:"18px",titleFontSizeLarge:"18px",titleFontSizeHuge:"18px",closeIconSize:"18px",closeSize:"22px"};function Wt(e){const{primaryColor:o,borderRadius:n,lineHeight:t,fontSize:i,cardColor:a,textColor2:d,textColor1:c,dividerColor:r,fontWeightStrong:l,closeIconColor:s,closeIconColorHover:g,closeIconColorPressed:h,closeColorHover:v,closeColorPressed:f,modalColor:x,boxShadow1:k,popoverColor:P,actionColor:C}=e;return Object.assign(Object.assign({},Dt),{lineHeight:t,color:a,colorModal:x,colorPopover:P,colorTarget:o,colorEmbedded:C,colorEmbeddedModal:C,colorEmbeddedPopover:C,textColor:d,titleTextColor:c,borderColor:r,actionColor:C,titleFontWeight:l,closeColorHover:v,closeColorPressed:f,closeBorderRadius:n,closeIconColor:s,closeIconColorHover:g,closeIconColorPressed:h,fontSizeSmall:i,fontSizeMedium:i,fontSizeLarge:i,fontSizeHuge:i,boxShadow:k,borderRadius:n})}const Lo={name:"Card",common:ie,self:Wt},Kt=p([z("card",`
