...
`,[S("absolute",`
 ...
 `),S("round",[p("&::before",`
 border-radius: 50%;
 `)])]),Ne=M({name:"BaseClose",props:{isButtonTag:{type:Boolean,default:!0},clsPrefix:{type:String,required:!0},disabled:{type:Boolean,default:void 0},focusable:{type:Boolean,default:!0},round:Boolean,onClick:Function,absolute:Boolean},setup(e){return ht("-base-close",At,ne(e,"clsPrefix")),()=>{const{clsPrefix:o,disabled:n,absolute:t,round:i,isButtonTag:a}=e;return f(a?"button":"div",{type:a?"button":void 0,tabindex:n||!e.focusable?-1:0,"aria-disabled":n,"aria-label":"close",role:a?void 0:"button",disabled:n,class:[`${o}-base-close`,t&&`${o}-base-close--absolute`,n&&`${o}-base-close--disabled`,i&&`${o}-base-close--round`],onMousedown:c=>{e.focusable||c.preventDefault()},onClick:e.onClick},f(we,{clsPrefix:o},{default:()=>f(Lo,null)}))}}}),{cubicBezierEaseIn:xo,cubicBezierEaseOut:Co}=ko;function _t({transformOrigin:e="inherit",duration:o=".2s",enterScale:n=".9",originalTransform:t="",originalTransition:i=""}={}){return[p("&.fade-in-scale-up-transition-leave-active",{transformOrigin:e,transition:`opacity ${o} ${xo}, transform ${o} ${xo} ${i&&`,${i}`}`}),p("&.fade-in-scale-up-transition-enter-active",{transformOrigin:e,transition:`opacity ${o} ${Co}, transform ${o} ${Co} ${i&&`,${i}`}`}),p("&.fade-in-scale-up-transition-enter-from, &.fade-in-scale-up-transition-leave-to",{opacity:0,transform:`${t} scale(${n})`}),p("&.fade-in-scale-up-transition-leave-from, &.fade-in-scale-up-transition-enter-to",{opacity:1,transform:`${t} scale(1)`})]}const{cubicBezierEaseInOut:q,cubicBezierEaseOut:Tt,cubicBezierEaseIn:Ht}=ko;function Nt({overflow:e="hidden",duration:o=".3s",originalTransition:n="",leavingDelay:t="0s",foldPadding:i=!1,enterToProps:a=void 0,leaveToProps:d=void 0,reverse:c=!1}={}){const r=c?"leave":"enter",l=c?"enter":"leave";return[p(`&.fade-in-height-expand-transition-${l}-from,
